...
export function InventoryTableManager({ data, onDelete, sortConfig, onSort }) {
  // Managers have similar view to admin but *could* restrict some actions/columns if desired
  const columns = [
